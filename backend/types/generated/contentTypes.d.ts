...
export interface ApiDiscountedProductDiscountedProduct
  extends Schema.CollectionType {
  collectionName: 'discounted_products';
  info: {
    singularName: 'discounted-product';
    pluralName: 'discounted-products';
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::discounted-product.discounted-product',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    iamge: Attribute.Media<'images' | 'files' | 'videos' | 'audios', true>;
...
export interface ApiSliderBannerSliderBanner extends Schema.CollectionType {
  ...
  info: {
    singularName: 'slider-banner';
    pluralName: 'slider-banners';
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::slider-banner.slider-banner',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiSliderStorySliderStory extends Schema.CollectionType {
  collectionName: 'slider_stories';
  info: {
    singularName: 'slider-story';
    pluralName: 'slider-stories';
    displayName: 'SliderStory';
    description: '';
  };
  options: {
    draftAndPublish: true;
